    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="#">寝室列表</a></li>
                <li class="active"><a href="#about">寝室人员列表</a></li>
    ...
    <div class="updateDiv">
        <div class="panel panel-success">
            ...
            <div class="panel-body" align="center">
                <form method="post" action="/stuInfo/editStuInfo" role="form">
                    <table class="editTable">
                        <tr>
                            <div class="form-group row">
                                <label for="stu_id" class="col-sm-2 col-form-label">学号</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="stu_id" id="stu_id" value="${tempStuInfo.stu_id}">
                                </div>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="stu_name" id="stu_name" value="${tempStuInfo.stu_name}">
                                </div>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="stu_admDate" id="stu_admDate" value="${tempStuInfo.stu_admDate?string("yyyy-MM-dd")}">
                                </div>
                            </div>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="stu_gender" id="boy" value="男" <#if tempStuInfo.stu_gender=='男'>checked</#if>>
                                <label class="form-check-label" for="boy">男</label>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input class="form-check-input" type="radio" name="stu_gender" id="girl" value="女" <#if tempStuInfo.stu_gender=='女'>checked</#if>>
